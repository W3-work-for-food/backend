...
from api.v1.views import (AmbassadorsViewSet, ContentViewSet, MerchViewSet,
                          SentMerchViewSet, UserAPIView, notification_detail, notification_list)
...
urlpatterns = [
    ...
    path('notifications/viewed/', notification_list, {'status': 'read'}, name='notification-viewed-list'),
]
